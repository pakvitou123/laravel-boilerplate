                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <img class="img-responsive" style=" height: 300px;width: 100%"  src="{{asset('/img/group/'.$group->img)}}">
                                </div>
                                <div class="panel-footer">
                                    ...
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">Setting
                                            <span class="caret"></span>
                                        </button>
                                        <ul class="dropdown-menu" role="menu">
                                    ...
                                    <ul class="list-group" id="contact-list">
                                        <li class="list-group-item">
                                            ...
                                            <div class="col-xs-12 col-md-10">
                                                <a href="" style="color: black">The cart does not contain rowId ce5452f389f041ab17e46324cc050c0d.</a><br>
