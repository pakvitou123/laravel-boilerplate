                                ...
                                <ul class="list-group" id="contact-list">
                                    ...
                                    @foreach($result_question as $result_questions)
                                        <li class="list-group-item ">
                                            ...
                                            <div class="col-sm-1">
                                                {{--<a href="{{route('editquestion', [$result_questions->id])}}"><i class="fa fa-pencil-square-o fa-2x" aria-hidden="true"></i></a>--}}
                                                {{--<a href="{{route('deletequestion', [$result_questions->id])}}"><i class="fa fa-trash-o fa-2x" aria-hidden="true"></i></a>--}}
                                            </div>
                                            <div class="clearfix"></div>
                                        </li>
                                    @endforeach
                            ...
                            <div class="container-fluid">
                                <ul class="list-group" id="contact-list">
                                    ...
                                    @foreach($result_group as $result_groups)
                                        ...
                                        <li class="list-group-item">
                                            <div class="col-sm-2">
                                                <img src="{{asset('/img/group/'.$result_groups->img )}}" alt="Todd Shelton" class="img-responsive img-circle" style="width: 50px;height: 50px">
                                            </div>
                                            <div class="col-md-7">
                                                <a href="{{route('index',[$result_groups->id])}}" style="color: black"><h4>{{$result_groups->name}}</h4></a>
                                            </div>
                                            <div class="col-sm-2">
                                                <p>09 member</p>
                                            </div>
